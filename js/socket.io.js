// Some Clay.io tweaks to not mess with other socket.io versions
// Resetting the clayio messes with games that already include socket.io
var clayio = "undefined" == typeof socketModule ? {} : socketModule.exports; // attach the io to Clay.io
if (typeof io === 'undefined') // Gamemaker has conflicts with this, so we use clayio by default, but some browsers / internet speeds hate it?
    var io = clayio;
...
(function() {
    ...
    })("object" == typeof socketModule ? socketModule.exports : this.clayio = {}, this),
    function(a, b) {
        var c = a.util = {},
            d = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
    ...
    }("undefined" != typeof clayio ? clayio : socketModule.exports, this),
    function(a, b) {
        function c() {}
    ...
    }("undefined" != typeof clayio ? clayio : socketModule.exports, "undefined" != typeof clayio ? clayio : socketModule.parent.exports),
    ...
    }("undefined" != typeof clayio ? clayio : socketModule.exports, typeof JSON != "undefined" ? JSON : undefined),
    function(a, b) {
        var c = a.parser = {},
...
//            if (this.isXDomain() && !b.util.ua.hasCORS) {   //decamincow
...
//            }
    ...
    }("undefined" != typeof clayio ? clayio : socketModule.exports, "undefined" != typeof clayio ? clayio : socketModule.parent.exports, this),
    function(a, b) {
        function c(a, b) {
    ...
    }("undefined" != typeof clayio ? clayio.Transport : socketModule.exports, "undefined" != typeof clayio ? clayio : socketModule.parent.exports, this),
    function(a, b, c) {
        function d(a) {
            if (!a) return;
    ...
    }("undefined" != typeof clayio ? clayio.Transport : socketModule.exports, "undefined" != typeof clayio ? clayio : socketModule.parent.exports),
    function(a, b, c) {
        function d() {
            b.Transport.XHR.apply(this, arguments)
        }
